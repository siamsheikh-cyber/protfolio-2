function LeftHero() {
    return (
        <div className="">
            ...
            <h2 className="text-[38px] sm:text-[50px] font-bold pb-3.5 dark:bg-gradient-to-r dark:from-[#12C85B] dark:via-[#6C62FF] dark:to-yellow-500 dark:bg-clip-text dark:text-transparent">I AM SIAM SHEIKH</h2>
