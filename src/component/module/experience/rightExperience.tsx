        ...
        <div className="basis-[50%]">
            <div className="sm:pl-32 sm:pt-10 relative">
                <span className="w-[165px] h-[175px]  hidden sm:block top-[30px] left-[20px] z-0 border-dashed border-gray-400 border-[2px] absolute ">
                    <span className="w-[165px] h-[175px] border-[2px] border-dotted border-gray-400 absolute"> <span className="w-[150px] h-[160px] border-[2px] top-[4px] left-[4px] border-gray-300 border-dashed  absolute "></span>
                    </span>
                </span>
